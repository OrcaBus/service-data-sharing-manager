...
EVENT_DETAIL_TYPE_PACKAGING_JOB_STATE_CHANGE_ENV_VAR = "EVENT_DETAIL_TYPE_PACKAGING_JOB_STATE_CHANGE"
EVENT_DETAIL_TYPE_PUSH_JOB_STATE_CHANGE_ENV_VAR = "EVENT_DETAIL_TYPE_PUSH_JOB_STATE_CHANGE"
...
def get_default_job_patch_entry() -> 'JobPatch':
    from .models import JobPatch, JobStatusType
