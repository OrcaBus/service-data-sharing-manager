...
# Local imports
from .globals import JobStatusType, PACKAGING_ENDPOINT, PUSH_JOB_ENDPOINT
...
def update_package_status(job_id: str, job_status: JobStatusType, error_message: Optional[str] = None) -> PackageResponseDict:
    """
...
def update_push_job_status(job_id: str, job_status: JobStatusType, error_message: Optional[str] = None) -> PushJobResponseDict:
    return patch_request(
