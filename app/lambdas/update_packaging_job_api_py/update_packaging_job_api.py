...
from orcabus_api_tools.data_sharing import update_package_status
from orcabus_api_tools.data_sharing.models import PackageStatusType
...
def handler(event, context):
    ...
    status: PackageStatusType = event.get('status')
