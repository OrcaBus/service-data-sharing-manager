...
if typing.TYPE_CHECKING:
    from data_sharing_tools.utils.models import SecondaryAnalysisDataType, DataType
...
def handler(event, context):
    ...
    data_type_list: Optional[List['DataType']] = event.get("dataTypeList")
    defrost_archived_fastqs: Optional[bool] = event.get("defrostArchivedFastqs")
    secondary_analysis_type_list: Optional[List['SecondaryAnalysisDataType']] = event.get("secondaryAnalysisTypeList")
    ...
    data_type_list: List['DataType'] = list(set(data_type_list))

    # Secondary analysis data type list
    if secondary_analysis_type_list is not None:
        secondary_analysis_type_list: List['SecondaryAnalysisDataType'] = list(set(list(map(
            lambda secondary_analysis_workflow_iter_: secondary_analysis_workflow_iter_.lower(),
    ...
    return {
        ...
        "secondaryAnalysisTypeList": secondary_analysis_type_list
    }
